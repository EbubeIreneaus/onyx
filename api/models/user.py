...
class User(Base):
    ...
    paystack_customer_id: Mapped[Optional[str]] = mapped_column(String(50), unique=True, nullable=True)
    is_admin: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    admin_priviledges: Mapped[List[AdminPermission]] = mapped_column(JSON, nullable=True)
...
class Subscription(Base):
    ...
    paystack_subscription_code: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    paystack_email_token: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
