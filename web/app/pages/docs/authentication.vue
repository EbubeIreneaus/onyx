        ...
        <table class="w-full text-left text-xs text-zinc-300">
          ...
          <tbody class="divide-y divide-zinc-800/60 font-mono">
            <tr>
              ...
              <td class="py-3 px-4 text-zinc-400 font-sans">
                No Authorization or X-API-Key header was included.
              </td>
            </tr>
            <tr>
              <td class="py-3 px-4 text-rose-400 font-bold">
              ...
              <td class="py-3 px-4 text-zinc-400 font-sans">
                The API key passed is invalid or has been revoked.
              </td>
            </tr>
            <tr>
              ...
              <td class="py-3 px-4">
                API access is not enabled on your tier...
              </td>
              <td class="py-3 px-4 text-zinc-400 font-sans">
                Your subscription plan does not include <code class="text-emerald-400">api:access</code>.
              </td>
            </tr>
          </tbody>
        </table>
