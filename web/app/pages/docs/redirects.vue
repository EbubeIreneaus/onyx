...
<template>
  <div class="space-y-10">
    <div>
      ...
      <h1 class="text-3xl font-extrabold text-white">Redirects & Short Links API</h1>
    ...
    <div class="space-y-4 p-6 bg-zinc-900 border border-zinc-800 rounded-2xl">
      ...
      <p class="text-xs text-zinc-400">Creates a short link under the default domain or a verified custom domain.</p>
  ...
  "expired_on": "2026-08-16T18:30:00Z"
    ...
    <div class="space-y-4 p-6 bg-zinc-900 border border-zinc-800 rounded-2xl">
      ...
      <p class="text-xs text-zinc-400">Retrieves detailed click charts, geolocation by country, device breakdown, and visitor logs.</p>
  ...
  "devices": [
    ...
    <div class="space-y-4 p-6 bg-zinc-900 border border-zinc-800 rounded-2xl">
      ...
      <p class="text-xs text-zinc-400">Public resolution endpoint called when visitors load short link pages. Uses Redis caching and enqueues background visitor tracking.</p>
