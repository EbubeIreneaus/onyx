  ...
  <div class="max-w-6xl mx-auto space-y-8 pb-12">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-extrabold text-white flex items-center gap-2.5">
          <UIcon name="i-lucide-shield-check" class="w-7 h-7 text-rose-500" />
    ...
    <template v-else-if="stats">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Users Card -->
        <NuxtLink to="/admin/users" class="p-5 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-2xl space-y-3 group transition-all">
          <div class="flex items-center justify-between">
        ...
        <!-- Redirects Card -->
        <NuxtLink to="/admin/links" class="p-5 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-2xl space-y-3 group transition-all">
          <div class="flex items-center justify-between">
        ...
        <div class="p-5 bg-zinc-900 border border-zinc-800 rounded-2xl space-y-3">
          ...
          <div class="text-3xl font-extrabold text-white font-mono">{{ stats.total_visits }}</div>
          <p class="text-xs text-zinc-400">Resolved visitor redirections</p>
        </div>

        <!-- Domains Card -->
        <NuxtLink to="/admin/domains" class="p-5 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-2xl space-y-3 group transition-all">
          <div class="flex items-center justify-between">
      ...
      <div class="space-y-4">
        <h2 class="text-lg font-bold text-white flex items-center gap-2">
          <UIcon name="i-lucide-sliders" class="w-5 h-5 text-rose-400" />
          Administrative Tools
        </h2>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <NuxtLink to="/admin/users" class="p-6 bg-zinc-900/60 border border-zinc-800 hover:border-rose-500/50 rounded-2xl space-y-2 group transition-all">
            <div class="flex items-center justify-between">
              <span class="font-bold text-white group-hover:text-rose-400 transition-colors flex items-center gap-2">
                <UIcon name="i-lucide-users" class="w-5 h-5 text-emerald-400" />
                User Management
              </span>
              <UIcon name="i-lucide-arrow-right" class="w-4 h-4 text-zinc-500 group-hover:text-rose-400" />
            </div>
            <p class="text-xs text-zinc-400">Search users, suspend/reinstate accounts, update roles, and manage user tier subscriptions.</p>
          </NuxtLink>

          <NuxtLink to="/admin/domains" class="p-6 bg-zinc-900/60 border border-zinc-800 hover:border-rose-500/50 rounded-2xl space-y-2 group transition-all">
            <div class="flex items-center justify-between">
              <span class="font-bold text-white group-hover:text-rose-400 transition-colors flex items-center gap-2">
                <UIcon name="i-lucide-globe" class="w-5 h-5 text-cyan-400" />
          ...
          <NuxtLink to="/admin/links" class="p-6 bg-zinc-900/60 border border-zinc-800 hover:border-rose-500/50 rounded-2xl space-y-2 group transition-all">
            <div class="flex items-center justify-between">
              <span class="font-bold text-white group-hover:text-rose-400 transition-colors flex items-center gap-2">
                <UIcon name="i-lucide-link" class="w-5 h-5 text-indigo-400" />
          ...
          <NuxtLink to="/admin/tiers" class="p-6 bg-zinc-900/60 border border-zinc-800 hover:border-rose-500/50 rounded-2xl space-y-2 group transition-all">
            <div class="flex items-center justify-between">
              <span class="font-bold text-white group-hover:text-rose-400 transition-colors flex items-center gap-2">
                <UIcon name="i-lucide-layers" class="w-5 h-5 text-amber-400" />
